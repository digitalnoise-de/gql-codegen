...
abstract class ClassGeneratorTestCase extends TestCase
{
    ...
    protected function assertClassHasPublicMethod(string $method, string $className)
    {
     ...
     */
    protected function assertClassHasPublicMethods(array $methods, string $className)
    {
    ...
    protected function assertMethodHasParameters(string $method, array $parameters, string $className)
    {
